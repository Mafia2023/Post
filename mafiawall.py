...
x====The unstoppable loader wazz x Mafia iinside ====x

\035[91;1m[[ AUTHOR NAME ]]       X MaFiia

\030[91;1m[[ TOOL ]]            POST FIGHT WALL
...
print ("[-[ TH3 T00L CREATE BY  X MAFIA IINSIDE  ]-]")
...
msg6=str(input("➣enter Taty name:"))
